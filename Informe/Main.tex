...
\title{Inserción laboral migrante en Chile:\\brechas, segmentación y desigualdad} %Cambiar según el título de su tesis
\author{Benjamín Infante\\Camilo Riquelme} %Cambiar según el nombre del autor
...
\raggedbottom  % evita Overfull/Underfull \vbox en paginas con poco contenido
